...
def rand_dates(start, n):
    # Fix for TypeError: converts numpy int64 to standard python int for timedelta
...
# 1. CapEx Data (Fixes KeyError: 'forecast_spend_usd')
capex = pd.DataFrame({
...
# 2. Facility Readiness Tasks (Fixes KeyError: 'task_name' and 'risk_level')
tasks = pd.DataFrame({
