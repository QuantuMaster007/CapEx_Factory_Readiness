...
<table>
  <tr>
    <td style="vertical-align: top; width: 65%;">
      <h2>About</h2>
      <p>
        A factory readiness + CapEx governance portfolio project built in a TPM/EPM operating style:
        readiness gating, critical-path visibility, CapEx variance tracking, and evidence packs generated in CI.
      </p>
    </td>
